...
public class ventanaEliminarEmpleado {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ventanaEliminarEmpleado window = new ventanaEliminarEmpleado();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 453, 403);
		...
		JLabel lblEliminarUsuarioAdministrativo = new JLabel("Eliminar Usuario Administrativo");
		lblEliminarUsuarioAdministrativo.setEnabled(false);
		lblEliminarUsuarioAdministrativo.setBounds(140, 6, 201, 16);
		panel.add(lblEliminarUsuarioAdministrativo);
		...
		btnBuscar.setBounds(276, 26, 117, 29);
		panel.add(btnBuscar);
		...
		btnEliminar.setBounds(330, 352, 117, 29);
